...
namespace Cysharp.Threading.Tasks.Internal {
    internal static class DiagnosticsExtensions {
        private static bool s_DisplayFilenames = true;

        private static readonly Regex s_TypeBeautifyRegex = new("`.+$", RegexOptions.Compiled);

        private static readonly Dictionary<Type, string> s_BuiltInTypeNames = new() {
            { typeof(void), "void" },
            { typeof(bool), "bool" },
            { typeof(byte), "byte" },
            { typeof(char), "char" },
        ...
        private static string BeautifyType(Type t, bool shortName) {
            ...
            if (!t.IsGenericType) {
                return shortName ? t.Name : t.FullName.Replace("Cysharp.Threading.Tasks.Triggers.", "")
            ...
            return s_TypeBeautifyRegex.Replace(genericType, "")
