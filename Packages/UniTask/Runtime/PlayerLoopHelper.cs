...
namespace Cysharp.Threading.Tasks {
    ...
    public static class PlayerLoopHelper {
        private static readonly ContinuationQueue s_ThrowMarkerContinuationQueue = new(PlayerLoopTiming.Initialization);

        private static readonly PlayerLoopRunner s_ThrowMarkerPlayerLoopRunner = new(PlayerLoopTiming.Initialization);
        ...
        internal static string ApplicationDataPath => s_ApplicationDataPath;

        public static bool IsMainThread => Thread.CurrentThread.ManagedThreadId == s_MainThreadId;

        private static int s_MainThreadId;
        private static string s_ApplicationDataPath;
        private static SynchronizationContext s_UnitySynchronizationContext;
        private static ContinuationQueue[] s_Yielders;
        private static PlayerLoopRunner[] s_Runners;
        ...
        private static void Init() {
            ...
            if (!domainReloadDisabled && s_Runners != null) {
                return;
            }
#else
            if (s_Runners != null) {
        ...
        private static void ForceEditorPlayerLoopUpdate() {
            ...
            if (s_Yielders != null) {
                foreach (var item in s_Yielders) {
                    if (item != null)
                        item.Run();
                }
            }
        ...
        private static void InsertLoop(
            ...
            if ((injectTimings & targetTimings) == targetTimings) {
                copyList[i].subSystemList = InsertRunner(
                    ...
                    injectOnFirst,
                    loopRunnerYieldType,
                    s_Yielders[index] = new ContinuationQueue(playerLoopTiming),
                    loopRunnerType,
                    s_Runners[index] = new PlayerLoopRunner(playerLoopTiming)
                );
            } else {
        ...
        public static void Initialize(
            ...
            s_Yielders = new ContinuationQueue[16];
            s_Runners = new PlayerLoopRunner[16];
            ...
            InsertLoop(
                ...
                typeof(UniTaskLoopRunners.UniTaskLoopRunnerTimeUpdate),
            ...
            InsertLoop(
                ...
                typeof(UniTaskLoopRunners.UniTaskLoopRunnerLastTimeUpdate),
        ...
        public static void AddAction(PlayerLoopTiming timing, IPlayerLoopItem action) {
            var runner = s_Runners[(int)timing];
