...
namespace Cysharp.Threading.Tasks.Linq {
    ...
    internal sealed class SkipUntil<TSource> : IUniTaskAsyncEnumerable<TSource> {
        ...
        public IUniTaskAsyncEnumerator<TSource> GetAsyncEnumerator(CancellationToken cancellationToken = default) {
            if (m_Other2 != null) {
                return new InnerSkipUntil(m_Source, this.m_Other2(cancellationToken), cancellationToken);
            } else {
                return new InnerSkipUntil(m_Source, this.m_Other, cancellationToken);
            }
        }

        private sealed class InnerSkipUntil : MoveNextSource, IUniTaskAsyncEnumerator<TSource> {
