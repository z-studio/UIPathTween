...
namespace Cysharp.Threading.Tasks.Linq {
    public static partial class UniTaskAsyncEnumerable {
        public static UniTask<Boolean> AllAsync<TSource>(
        ...
        public static UniTask<Boolean> AllAwaitAsync<TSource>(
            this IUniTaskAsyncEnumerable<TSource> source,
    ...
    internal static class All {
        internal static async UniTask<bool> AllAsync<TSource>(
        ...
        internal static async UniTask<bool> AllAwaitAsync<TSource>(
            IUniTaskAsyncEnumerable<TSource> source,
            Func<TSource, UniTask<Boolean>> predicate,
            CancellationToken cancellationToken
        ) {
