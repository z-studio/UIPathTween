...
namespace Cysharp.Threading.Tasks.Linq {
    public static partial class UniTaskAsyncEnumerable {
        public static IUniTaskAsyncEnumerable<TSource> SkipLast<TSource>(
    ...
    internal sealed class SkipLast<TSource> : IUniTaskAsyncEnumerable<TSource> {
        ...
        public IUniTaskAsyncEnumerator<TSource> GetAsyncEnumerator(CancellationToken cancellationToken = default) {
            return new InnerSkipLast(m_Source, m_Count, cancellationToken);
        }

        private sealed class InnerSkipLast : MoveNextSource, IUniTaskAsyncEnumerator<TSource> {
            ...
            public InnerSkipLast(IUniTaskAsyncEnumerable<TSource> source, int count, CancellationToken cancellationToken) {
                m_Source = source;
                m_Count = count;
