...
namespace Cysharp.Threading.Tasks {
    ...
    public static class UniTaskScheduler {
        ...
        // cache delegate.
        private static readonly SendOrPostCallback s_HandleExceptionInvoke = InvokeUnobservedTaskException;
            ...
            if (ex != null) {
                ...
                if (UnobservedTaskException != null) {
                    if (!DispatchUnityMainThread
                        ...
                        // Post to MainThread.
                        PlayerLoopHelper.UnitySynchronizationContext.Post(s_HandleExceptionInvoke, ex);
                    }
                } else {
                    string msg = null;
